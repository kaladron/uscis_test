...
const _$_stateAnswersRawJsonLiteral = {
  'Alabama': {
    'governor': ['Kay Ivey', 'Ivey'],
    'capital': 'Montgomery',
    'senators': [
      'Richard C. Shelby',
      'Richard Shelby',
  ...
  'California': {
    ...
    'capital': 'Sacramento',
    'senators': ['Alex Padilla', 'Padilla', 'Dianne Feinstein', 'Feinstein']
  }
};
